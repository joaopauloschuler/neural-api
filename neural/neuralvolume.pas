...
uses {$IFNDEF x64} NeuralAVX {$ELSE} NeuralAVXx64{$ENDIF}, neuralbit, Math,
...
procedure TestAVX;
  function DotProd(PtrA, PtrB: TNeuralFloatArrPtr; NumElements: integer) : single;
  var i: Integer;
  begin
       Result := 0;
  ...
  procedure MulAdd( PtrA, PtrB: TNeuralFloatArrPtr; NumElements: integer; fact : single );
  var i : integer;
  begin
       for i := 0 to NumElements - 1 do
...
begin
     ...
     Writeln('AVX Dot Prod');
     for i := 1 to Length(a) do
     begin
          r1 := DotProd( @a[0], @b[0], i);
          r2 := AVXDotProd( @a[0], @b[0], i );
