program CaiOptimizedDenseNet48;
(*
...
type
  ...
  begin
    ...
    fileNameBase := 'CaiOptimizedDenseNet48';
    HasMovingNorm := true;
    NN.AddLayer( TNNetInput.Create(48, 48, 3).EnableErrorCollection() );
...
begin
  ...
  Application.Title:='CIFAR-10 Classification Example Resizing Input to 48x48';
  Application.Run;
  Application.Free;
end.
